...
//			logger.error("---------------"+"jdbc:oracle:thin:@"+dburl+":"+databaseName);
...
//		stmt.executeUpdate(sql);
	 ...
	 * @throws IOException
	 */
	public static Properties getPprVue(String name) {
		InputStream inputStream = DbFH.class.getClassLoader().getResourceAsStream(name);
